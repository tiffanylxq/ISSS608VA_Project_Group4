...
| Scenario (Dropdown)     | User can select the type of scenario they would like to visualize. Select 'Top 5' or 'Top 10' to view the top 5 or top 10 businesses to see which companies are prospering. |
...
2. User can select the number of employees employed by each employer, the default selection is to show all employees under each employer. 

3. User can select the number of jobs offered by each employer.
