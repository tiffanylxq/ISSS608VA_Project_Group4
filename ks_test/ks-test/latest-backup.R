...
# Please revert to Participants.csv after testing
                           ...
                           tabPanel("Patterns with Heatmap", 
                                    ...
                                    mainPanel(
                                      ...
                                      plotlyOutput(outputId = "plot3", 
                                        ...
                                        mainPanel(
                                          plotlyOutput(outputId = "plot4", height=400), 
                                          plotlyOutput(outputId = "plot5", height=400), 
                                          plotlyOutput(outputId = "plot6", height=400), 
                                          plotlyOutput(outputId = "plot7", height=400), 
                                          plotlyOutput(outputId = "plot8", height=400), 
                                          plotlyOutput(outputId = "plot9", height=400), 
