...
![Employer-Employee Tab Visualisation Chart](Q3_Map.png)


 
There are 6 features within this tab:  

+------------+-----------------------------------------------------------------------------+
| Feature    |  Function                                                                   |
+============+=============================================================================+
| Map/Chart  | User has the option to choose between map or chart view.                    |
+------------+-----------------------------------------------------------------------------+
| Entity View| User see more information (employer ID, job ID) within each building ID.    |
+------------+-----------------------------------------------------------------------------+
| City Map   | User will be able to see turnover rate and number of employees for each     |
|            | employer in each building.                                                  |
+------------+-----------------------------------------------------------------------------+
| Control    | User filter through the options to different scenario.                      |
| Panel      |                                                                             |
+------------+-----------------------------------------------------------------------------+
| Timeline   | User has the ability to scope to the target range date, there will also be  |
|            | a function to auto play and see the changes over time.                      |
+------------+-----------------------------------------------------------------------------+
| Multiple   | User can select maximum 5 employers to see change in their number of        |
| Employers  | employees over time.                                                        |
+------------+-----------------------------------------------------------------------------+


![Employer-Employee Tab Visualisation Chart](Q3_Chart.png)

There are 4 charts for the users to explore, each will have tooltip when hover over:  

+------------+-----------------------------------------------------------------------------+
| Feature    |  Function                                                                   |
+============+=============================================================================+
| Line Chart1| Percentage % Change of Employees For Each Work Week                         |
+------------+-----------------------------------------------------------------------------+
| Line Chart2| Number of Employees For Each Work Week                                      |
+------------+-----------------------------------------------------------------------------+
| Boxplot    | Wage Distribution for Different Education Level                             |
+------------+-----------------------------------------------------------------------------+
| Heatmap    | Each cube = Employer, Size = No. of Employee, Color = Age of Employees      |
+------------+-----------------------------------------------------------------------------+
...
This refers to the general state of each employer which is described by the employment pattern and turnover rate from the chart and map view respectively.  

[*Pointer 2: "What employment patterns do you observe?*]{.underline}

The wage and age distribution under the chart view give hints on possible patterns. 

[*Pointer 3: "Do you notice any areas of particularly high or low turnover?*]{.underline}

The different color intensity of turnover rate gives user a sensing across all employers with accompanying line charts for more statistical information.
...
+-------------------------+-----------------------------------------+
| lubridate, zoo          | To make it easier to work with dates    |
|                         | and times.                              |
+-------------------------+-----------------------------------------+
