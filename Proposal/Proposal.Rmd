...
|            | Dataset        | Description                          |
+============+================+======================================+
| 1          | Pa             | A collection of 72 Comma-Separated   |
|            | rtici          | Values (CSV) files, each containing  |
|            | pantStatusLogs | information about all participants'  |
...
+------------+----------------+--------------------------------------+
| 11         | Fi             | Information about the time and       |
|            | nancialJournal | amount participants spend on certain |
...
|            |                | Engagement.                          |
+------------+----------------+--------------------------------------+
| 13         | Trave lJournal | Information about the all travel     |
...
![Example of dashboard tab layout](overviewsolution.png)

### Overarching Question

*Design still pending discussion with team.*
...
The 4 features in which users can play around with are 
