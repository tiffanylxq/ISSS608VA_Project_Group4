...
In assessing which businesses within the city of Engagement are thriving, we consider two approaches by using the revenue generated and wages offered. Pubs and restaurants are two distinct businesses with participant's expenses data available. As such, the performance of pubs and restaurants are evaluated based on the accumulated sales. On the other hand, as wages are the only numeric data present for all employers, it will be the basis in comparing the financial prosperity of the employers.
...
The`Overview` sub-tab provides an overall glance of the business performance of pubs and restaurants. Users first select either pubs or restaurants to see the ranking in terms of overall sales based on the duration filtered. The data found to the right of the dashboard provides further insights on the sales performance of each business that falls under the selected category of pubs or restaurants arranged based on the average monthly sales in descending order. Users can also observe the monthly trend of each business through the sparklines available. Additionally, the map plot illuminates areas of the town where pubs or restaurants are flourishing.
...
A limitation identified by the team is the lack of data to better assess the health of businesses. Given more information, such as business expenses, it would enable the team to accurately determine the growth of a business by comparing the profits and losses over time.
