...
While tidyverse and lubridate packages are often used in the data preparation stage, packages such as plotly, ggplot2, tmap, sf are commonly used for visualization of plots.
